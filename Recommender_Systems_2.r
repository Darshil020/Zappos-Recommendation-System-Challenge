...
m1<- matrix(sample(c(NA,0:5),500000, replace=TRUE, prob=c(0.40,0.20,0.10,0.10,0.10,0.05,0.03)), 
            nrow=500, ncol=1000, dimnames = list(
...
e <- evaluationScheme(r[1:500], method="split", train=0.9,given=500);
